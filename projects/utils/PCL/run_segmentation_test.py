...
def main():
    ...
    if args.out is not None:
        ...
        raise ValueError('The output dir must be exist.')
    ...
    if not distributed:
        ...
        outputs = multi_gpu_test(model, data_loader, args.out, args.tmpdir, args.gpu_collect)
    ...
    if rank == 0:
        ...
        if args.format_only:
            ...
            raise ValueError(f'{args.format_only} not support.')
        if args.eval:
            # dataset.evaluate(outputs, args.eval, **kwargs)
            raise ValueError(f'{args.eval} not support.')
