...
config_path = '../configs/x_ray/pseudo/base_faster_mosaic.py'
...
import module
from projects.utils.commons import merge_coco


def merge_pseduo_with_train():
    a = '/fengyouliang/datasets/x-ray/coco/annotations/fold0/train.json'
    b = '/fengyouliang/datasets/x-ray/coco/annotations/fold0/pseudo_label_base_faster_mosaic.json'
    merge_coco(a, b, '/fengyouliang/datasets/x-ray/coco/annotations/fold0', 'pseudo_for_train')
