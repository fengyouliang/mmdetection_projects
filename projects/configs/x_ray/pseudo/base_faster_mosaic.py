...
pretrained = '/fengyouliang/model_output/work_dirs/x_ray/base_faster_mosaic/latest.pth'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + f'annotations/fold{fold_index}/pseudo_for_train.json',
